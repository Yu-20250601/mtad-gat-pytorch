...
def get_parser():
    ...
    parser.add_argument("--output_root", type=str, default="output", help="Root directory for experiment artifacts")
    ...
    parser.add_argument("--use_node_embedding", type=str2bool, default=True)
